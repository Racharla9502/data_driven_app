...
import 'start_project08_model.dart';
export 'start_project08_model.dart';

class StartProject08Widget extends StatefulWidget {
  const StartProject08Widget({super.key});

  @override
  State<StartProject08Widget> createState() => _StartProject08WidgetState();
}

class _StartProject08WidgetState extends State<StartProject08Widget> {
  late StartProject08Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StartProject08Model());
